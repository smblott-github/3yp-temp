...
public /*strictfp*/ class AntsForage extends SimState
    ...
    public SparseGrid2D antgrid = new SparseGrid2D(GRID_WIDTH, GRID_HEIGHT);
    ...
    public void start()
        ...
        antgrid = new SparseGrid2D(GRID_WIDTH, GRID_HEIGHT);
        ...
        for(int x=0; x < numAnts; x++)
            ...
            antgrid.setObjectLocation(ant,(HOME_XMAX+HOME_XMIN)/2,(HOME_YMAX+HOME_YMIN)/2);
